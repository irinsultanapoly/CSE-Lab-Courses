...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, email: $email, mobile: $mobile, activeStatus: $activeStatus, profilePicture: $profilePicture, address: $address, emailVerified: $emailVerified, mobileVerified: $mobileVerified)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, email, mobile,
      activeStatus, profilePicture, address, emailVerified, mobileVerified);
...
abstract class _User implements User {
  const factory _User(
      ...
      required final bool mobileVerified}) = _$UserImpl;
