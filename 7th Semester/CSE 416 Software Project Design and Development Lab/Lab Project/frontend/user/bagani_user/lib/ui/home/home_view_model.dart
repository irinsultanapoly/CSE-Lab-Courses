...
class PlantViewModel extends StateNotifier<AsyncValue<PlantState>> {
  ...
  Future<void> fetchPlant(int plantId) async {
    try {
      ...
      _logger.info('Plant fetched successfully for plant ID: $plantId');
    } catch (e, s) {
      _logger.severe(
